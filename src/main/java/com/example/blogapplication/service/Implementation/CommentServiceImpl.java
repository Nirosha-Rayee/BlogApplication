...
import com.example.blogapplication.service.CommentServiceInterface;
...
public class CommentServiceImpl implements CommentServiceInterface {
    ...
    public CommentDto createComment(long postId, CommentDto commentDto) {
        ...
        //set the post entity to the comment
...
//        commentDto.setBody(comment.getBody());
    ...
    private Comment mapToEntity(CommentDto commentDto) {
            ...
            Comment comment = mapper.map(commentDto, Comment.class); //used model mapper
